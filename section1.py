    ...
    def __init__(self):
        ...
        def browseFiles():
            ...
            fileLabel = customtkinter.CTkLabel(
                frame, text="File Name: "+filename).pack()
            df = section1func1(filename)
            dfLabel = customtkinter.CTkLabel(
                frame, text="Data Frame is Created in the HAPPENN.csv File!").pack()
            FileIsOpenedLabel = customtkinter.CTkLabel(
                frame, text="Your FILE Is Opened In New EXCEL Sheet!", font=("Roboto", 20)).pack()
