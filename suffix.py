import main
from SectionsAlgorithms.AlgoSuffix import *
...
class suffixGUI(customtkinter.CTk):
    def __init__(self):
        super().__init__()
        ...
        suffixPartial = partial(suffix , seqVar1, resultLabel)
        suffixbtn = customtkinter.CTkButton(
            master=frame, text="Get Suffix!", command=suffixPartial).pack(padx=12, pady=12)
